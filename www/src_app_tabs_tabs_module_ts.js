(self["webpackChunkmy_app"] = self["webpackChunkmy_app"] || []).push([["src_app_tabs_tabs_module_ts"],{
...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'tab3',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_tab3_tab3_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../tab3/tab3.module */ 573)).then(m => m.Tab3PageModule)
            },
            {
                path: '',
